...
export class Move { // добавляем возможность передвижения
  constructor(options) {
...
export class Stand extends Move { // анимация персонажей во время их бездействия
  constructor(owner) {
    super({
      owner: owner,
...
export class Squat extends Move { //приседания
  constructor(owner) {
    super({
      owner,
